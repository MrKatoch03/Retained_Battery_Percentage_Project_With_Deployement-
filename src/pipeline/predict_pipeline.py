...
class PredictPipeline:
    ...
    def predict(self,features):
        """
        Make predictions on input featueres
        ...
        try:
            ...
            model_path = r'D:\MLOPSS\Project 1\artifacts\model.pkl'
            label_encoders_path = r'D:\MLOPSS\Project 1\artifacts\label_encoder.pkl'
            power_transformer_path = r'D:\MLOPSS\Project 1\artifacts\power_transformer.pkl'

            # Load all preprocessor 
            ...
            logging.info("Apply label encoding to categorical featuers...")
            ...
            #Created DataFrame with transformed features
            ...
            logging.error(f"Error in prediction pipeline")
